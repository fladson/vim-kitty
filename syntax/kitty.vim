...
syn keyword kittyKeyword contained
 ...
 \ copy_on_select cursor cursor_beam_thickness cursor_blink_interval cursor_shape cursor_stop_blinking_after cursor_text_color cursor_underline_thickness
 \ default_pointer_shape detect_urls dim_opacity disable_ligatures draw_minimal_borders dynamic_background_opacity editor enable_audio_bell
 \ enabled_layouts env exe_search_path file_transfer_confirmation_bypass focus_follows_mouse font_family font_features font_size
 \ force_ltr foreground hide_window_decorations inactive_border_color inactive_tab_background inactive_tab_font_style inactive_tab_foreground inactive_text_alpha
 \ initial_window_height initial_window_width input_delay italic_font kitten_alias kitty_mod linux_bell_theme linux_display_server
 ...
 \ mark2_foreground mark3_background mark3_foreground modify_font mouse_hide_wait mouse_map narrow_symbols open_url_with
 ...
 \ term text_composition_strategy text_fg_override_threshold touch_scroll_multiplier undercurl_style update_check_interval url_color url_excluded_characters
 \ url_prefixes url_style visual_bell_color visual_bell_duration visual_window_select_characters watcher wayland_titlebar_color wheel_scroll_min_lines
...
syn keyword kittyAction contained
 ...
 \ eighth_window fifth_window first_window focus_visible_window fourth_window goto_layout goto_tab hide_macos_app
 \ hide_macos_other_apps input_unicode_character kitten kitty_shell last_used_layout launch layout_action load_config_file
 \ minimize_macos_window mouse_click_url mouse_click_url_or_select mouse_handle_click mouse_select_command_output mouse_selection mouse_show_command_output move_tab_backward
