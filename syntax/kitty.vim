...
syn keyword kittyKeyword contained
 ...
 \ adjust_line_height allow_hyperlinks allow_remote_control background background_image background_image_layout background_image_linear background_opacity
 \ background_tint bell_border_color bell_on_tab bell_path bold_font bold_italic_font box_drawing_scale clear_all_mouse_actions
 \ clear_all_shortcuts click_interval clipboard_control clipboard_max_size close_on_child_death color0 color1 color10
 ...
 \ mouse_hide_wait mouse_map narrow_symbols open_url_with paste_actions placement_strategy pointer_shape_when_dragging pointer_shape_when_grabbed
 \ remember_window_size repaint_delay resize_debounce_time resize_draw_strategy resize_in_steps scrollback_fill_enlarged_window scrollback_lines scrollback_pager
 \ scrollback_pager_history_size select_by_word_characters selection_background selection_foreground shell shell_integration single_window_margin_width startup_session
 \ strip_trailing_spaces symbol_map sync_to_monitor tab_activity_symbol tab_bar_align tab_bar_background tab_bar_edge tab_bar_margin_color
 \ tab_bar_margin_height tab_bar_margin_width tab_bar_min_tabs tab_bar_style tab_fade tab_powerline_style tab_separator tab_switch_strategy
 \ tab_title_template term touch_scroll_multiplier update_check_interval url_color url_excluded_characters url_prefixes url_style
 \ visual_bell_color visual_bell_duration visual_window_select_characters watcher wayland_titlebar_color wheel_scroll_min_lines wheel_scroll_multiplier window_alert_on_bell
 \ window_border_width window_logo_alpha window_logo_path window_logo_position window_margin_width window_padding_width window_resize_step_cells window_resize_step_lines
syn keyword kittyAction contained
 ...
 \ open_url_with_hints pass_selection_to_program paste paste_from_buffer paste_from_clipboard paste_from_selection paste_selection paste_selection_or_clipboard
 \ previous_tab previous_window quit remote_control remove_marker reset_window_sizes resize_window scroll_end
 ...
 \ scroll_to_prompt second_window select_tab send_text set_background_opacity set_colors set_tab_title seventh_window
 \ show_first_command_output_on_screen show_kitty_env_vars show_last_command_output show_last_visited_command_output show_scrollback signal_child sixth_window start_resizing_window
 \ swap_with_window tenth_window third_window toggle_fullscreen toggle_layout toggle_macos_secure_keyboard_entry toggle_marker toggle_maximized
