...
syn keyword kittyKeyword contained
 ...
 \ map mark1_background mark1_foreground mark2_background mark2_foreground mark3_background mark3_foreground mouse_hide_wait
 \ mouse_map open_url_with placement_strategy pointer_shape_when_dragging pointer_shape_when_grabbed remember_window_size repaint_delay resize_debounce_time
 \ resize_draw_strategy resize_in_steps scrollback_fill_enlarged_window scrollback_lines scrollback_pager scrollback_pager_history_size select_by_word_characters selection_background
 \ selection_foreground shell shell_integration single_window_margin_width startup_session strip_trailing_spaces symbol_map sync_to_monitor
 ...
 \ tab_bar_style tab_fade tab_powerline_style tab_separator tab_switch_strategy tab_title_template term touch_scroll_multiplier
 \ update_check_interval url_color url_excluded_characters url_prefixes url_style visual_bell_color visual_bell_duration visual_window_select_characters
 \ watcher wayland_titlebar_color wheel_scroll_multiplier window_alert_on_bell window_border_width window_logo_alpha window_logo_path window_logo_position
...
syn keyword kittyAction contained
 \ change_font_size clear_terminal close_os_window close_other_windows_in_tab close_tab close_window close_window_with_confirmation combine
 \ copy_and_clear_or_interrupt copy_or_interrupt copy_to_buffer copy_to_clipboard create_marker debug_config detach_tab detach_window
 \ disable_ligatures_in discard_event dump_lines_with_attrs edit_config_file eighth_window fifth_window first_window focus_visible_window
 \ fourth_window goto_layout goto_tab input_unicode_character kitten kitty_shell last_used_layout launch
 \ layout_action load_config_file mouse_click_url mouse_click_url_or_select mouse_handle_click mouse_select_command_output mouse_selection mouse_show_command_output
 ...
 \ ninth_window no_op nth_os_window nth_window open_url_with_hints pass_selection_to_program paste paste_from_buffer
 ...
 \ scroll_page_up scroll_to_mark scroll_to_prompt second_window select_tab send_text set_background_opacity set_colors
 \ set_tab_title seventh_window show_first_command_output_on_screen show_kitty_env_vars show_last_command_output show_last_visited_command_output show_scrollback signal_child
 \ sixth_window start_resizing_window swap_with_window tenth_window third_window toggle_fullscreen toggle_layout toggle_marker
 \ toggle_maximized
