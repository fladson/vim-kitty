...
syn keyword kittyKeyword contained
 ...
 \ mouse_hide_wait mouse_map narrow_symbols open_url_with placement_strategy pointer_shape_when_dragging pointer_shape_when_grabbed remember_window_size
 ...
 \ select_by_word_characters selection_background selection_foreground shell shell_integration single_window_margin_width startup_session strip_trailing_spaces
 ...
 \ tab_bar_margin_width tab_bar_min_tabs tab_bar_style tab_fade tab_powerline_style tab_separator tab_switch_strategy tab_title_template
 \ term touch_scroll_multiplier update_check_interval url_color url_excluded_characters url_prefixes url_style visual_bell_color
...
syn keyword kittyAction contained
 \ change_font_size clear_selection clear_terminal close_os_window close_other_windows_in_tab close_tab close_window close_window_with_confirmation
 \ combine copy_and_clear_or_interrupt copy_ansi_to_clipboard copy_or_interrupt copy_to_buffer copy_to_clipboard create_marker debug_config
 \ detach_tab detach_window disable_ligatures_in discard_event dump_lines_with_attrs edit_config_file eighth_window fifth_window
 \ first_window focus_visible_window fourth_window goto_layout goto_tab input_unicode_character kitten kitty_shell
 \ last_used_layout launch layout_action load_config_file mouse_click_url mouse_click_url_or_select mouse_handle_click mouse_select_command_output
 \ mouse_selection mouse_show_command_output move_tab_backward move_tab_forward move_window move_window_backward move_window_forward move_window_to_top
 ...
 \ next_tab next_window ninth_window no_op nth_os_window nth_window open_url_with_hints pass_selection_to_program
 \ paste paste_from_buffer paste_from_clipboard paste_from_selection paste_selection paste_selection_or_clipboard previous_tab previous_window
 \ quit remote_control remove_marker reset_window_sizes resize_window scroll_end scroll_home scroll_line_down
 \ scroll_line_up scroll_page_down scroll_page_up scroll_prompt_to_bottom scroll_to_mark scroll_to_prompt second_window select_tab
 \ send_text set_background_opacity set_colors set_tab_title seventh_window show_first_command_output_on_screen show_kitty_env_vars show_last_command_output
 \ show_last_visited_command_output show_scrollback signal_child sixth_window start_resizing_window swap_with_window tenth_window third_window
